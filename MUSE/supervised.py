...
PARAMETERS_NUM = {
    ...
    "resnet101": 44.55,
    "resnet152": 60.19,
    "bert_uncased_L-2_H-128_A-2": 4.4,
    "bert_uncased_L-4_H-256_A-4": 11.3,
    "bert_uncased_L-4_H-512_A-8": 29.1,
    "bert_uncased_L-8_H-512_A-8": 41.7,
...
parser.add_argument(
    "--exp_path", type=str, default="", help="Where to store experiment logs and models"
)
...
parser.add_argument(
    ...
    type=bool_flag,
    default=False,
    help="Use original precision calculation method",
)
