...
if model_type == "vm":
    dispersion_ranking_paths = [
        "./sorted_dispersion_vit-mae-huge.txt",
        "./sorted_dispersion_resnet152.txt",
        "./sorted_dispersion_segformer-b5-finetuned-ade-640-640.txt",
    ]
else:
    dispersion_ranking_paths = [
        "./sorted_dispersion_bert-large-uncased.txt",
